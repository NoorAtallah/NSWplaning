  ...
  return (
    <section className="bg-white flex flex-col overflow-hidden">
      ...
      >
        ...
        {/* GRID */}
        <div className="relative z-10 w-full grid grid-cols-1 lg:grid-cols-[55%_45%] items-center px-14 py-14 gap-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3 mb-8 flex-wrap">
              <div className="flex items-center gap-2 bg-[#013877] text-white text-[11px] font-bold tracking-[2px] uppercase px-4 py-2 rounded-full">
                <span className="w-2 h-2 rounded-full bg-[#74c6b4] inline-block" />
                NDIS Registered Provider
              </div>
              <div className="flex items-center gap-2 bg-white text-[#013877] text-[11px] font-bold tracking-[2px] uppercase px-4 py-2 rounded-full shadow-sm">
                <span className="w-2 h-2 rounded-full bg-[#efc759] inline-block" />
                Bankstown NSW
              </div>
            </div>

            {/* HEADING */}
            <h1 className="font-serif text-[58px] lg:text-[66px] leading-[1.07] tracking-[-2px] text-[#013877] mb-7 max-w-[600px]">
              Build a rewarding career in care & disability support
            </h1>

            <p className="text-[16px] font-medium text-[#013877]/60 max-w-[480px] leading-[1.85] mb-10">
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <button className="bg-[#013877] text-white text-[15px] font-bold px-9 py-4 rounded-xl hover:bg-[#012a5a] transition-colors shadow-lg shadow-[#013877]/20">
                Enquire Now →
              </button>
              <button className="bg-white text-[#013877] text-[15px] font-bold px-8 py-4 rounded-xl border-2 border-[#013877]/10 hover:border-[#013877]/30 transition-colors shadow-sm">
                Browse Courses
              </button>
            </div>

            {/* STATS */}
            <div className="flex items-stretch gap-0 w-fit rounded-2xl overflow-hidden border border-[#013877]/8 bg-white shadow-sm">
              <div className="flex flex-col items-center justify-center px-8 py-5 border-r border-[#013877]/8">
                <span className="font-serif text-[34px] text-[#013877] leading-none">6+</span>
                <span className="text-[11px] font-bold tracking-[1.5px] uppercase text-[#013877]/40 mt-1">Categories</span>
              </div>
              <div className="flex flex-col items-center justify-center px-8 py-5 border-r border-[#013877]/8">
                <span className="font-serif text-[34px] text-[#013877] leading-none">500+</span>
                <span className="text-[11px] font-bold tracking-[1.5px] uppercase text-[#013877]/40 mt-1">Graduates</span>
              </div>
              <div className="flex flex-col items-center justify-center px-8 py-5 border-r border-[#013877]/8">
                <span className="font-serif text-[34px] text-[#013877] leading-none">100%</span>
                <span className="text-[11px] font-bold tracking-[1.5px] uppercase text-[#013877]/40 mt-1">Online</span>
              </div>
              <div className="flex flex-col items-center justify-center px-8 py-5">
                <div className="flex gap-1 mb-1">
                  {[1,2,3,4,5].map(i => (
                    <span key={i} className="text-[#efc759] text-[13px]">★</span>
                  ))}
                </div>
                <span className="text-[11px] font-bold tracking-[1.5px] uppercase text-[#013877]/40">Reviews</span>
              </div>
            </div>
          ...
          <div className="relative flex items-center justify-center h-[520px]">
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-[#efc759] rounded-full px-5 py-2 shadow-md z-20">
